...
public class QRCodeUtil {
	...
	public static void encode(String content, String destPath, String filename) throws Exception {
		QRCodeUtil.encode(content, destPath, filename, false);
	}
	...
	public static void encode(String content, String imgPath,
			OutputStream output, String filename, boolean needCompress) throws Exception {
		BufferedImage image = QRCodeUtil.createImage(content, imgPath,
				needCompress);
	...
	public static void encode(String content, OutputStream output, String filename)
			throws Exception {
		QRCodeUtil.encode(content, null, output, filename, false);
	}
